...
You can read find more in the [ongoing PR for v8](https://github.com/stil4m/elm-syntax/pull/188) and in [`breaking-change` issues/PRs](https://github.com/stil4m/elm-syntax/labels/breaking%20change), but here's a few of the main intentions of the new version.
