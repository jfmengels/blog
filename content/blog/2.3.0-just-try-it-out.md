...
That was it for the notable and visible parts of the CLI. Note that thestarting from `2.3.0`, the CLI will only work if your review configuration depends on `jfmengels/elm-review` 2.3.0, which I am releasing today too, and which we will delve into now.
